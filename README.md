...
5. В результате профилировки выяснилось, самый долговыполняющийся метод- add_sensor, методы measure_acc, measure_gyro, measure_position - выполнялись примерно одинаковое количество времени,  метод list_sensors выполнялся быстрее всего. 
